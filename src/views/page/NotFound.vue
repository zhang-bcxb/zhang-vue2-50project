<template>
  <div class="body">
    <div class="g-container">
      <div class="rail">
        <div v-for="(letter, idx) in str404.split('')" :key="idx"
             :class="['stamp', letter==4?'four':'zero']">{{ letter }}
        </div>
      </div>
      <div class="world">
        <div class="forward">
          <div class="box">
            <div v-for="(item,index) in 6" :key="index" class="wall"></div>
          </div>
        </div>
      </div>
    </div>
    <div class="g-to">
      ...
      <div class="go-btn-box">
        <a href="/" class="svg-border-animation" rel="noopener noreferrer">
          <svg viewBox="0 0 80 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <rect class="shape" height="32" width="80"></rect>
          </svg>
